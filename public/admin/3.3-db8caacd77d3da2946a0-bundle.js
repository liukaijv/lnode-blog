...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] backend\\views\\category\\index.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		vuex: {
			actions: {
				indexAction: _category.indexAction,
				deleteAction: _category.deleteAction,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.deleteAction = exports.updateAction = exports.editAction = exports.storeAction = exports.createAction = exports.indexAction = undefined;
	...
	var indexAction = exports.indexAction = function indexAction(store) {
		...
		_http2.default.get('category', { params: { page: page } }).then(function (result) {
	...
	var createAction = exports.createAction = function createAction(store) {
		_http2.default.get('category/create').then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var storeAction = exports.storeAction = function storeAction(store, data) {
		_http2.default.post('category/create', data).then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var editAction = exports.editAction = function editAction(store) {
		...
		_http2.default.get('category/' + category_id + '/edit').then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var updateAction = exports.updateAction = function updateAction(store, data) {
		...
		_http2.default.put('category/' + category_id + '/edit', data).then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var deleteAction = exports.deleteAction = function deleteAction(store, category_id) {
		return new Promise(function (resolve, reject) {
			_http2.default.delete('category/' + category_id).then(function (result) {
				var data = result.data;
				if (data.success == true) {
