webpackJsonp([10],Array(56).concat([
/* 56 */
/***/ function(module, exports, __webpack_require__) {
	...
	instance.interceptors.request.use(function (config) {
		var access_token = sessionStorage.getItem('jwt_token');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.uploadAction = exports.pageAction = undefined;

	var _mutationTypes = __webpack_require__(45);

	var pageAction = exports.pageAction = function pageAction(store, module, page) {
	  store.dispatch('PAGE_CHANGE', module, page);
	};

	var uploadAction = exports.uploadAction = function uploadAction(file) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.deleteAttachmentAction = exports.uploadAttachmentAction = exports.editorAction = exports.deleteCoverAction = exports.uploadCoverAction = exports.deleteAction = exports.updateAction = exports.editAction = exports.storeAction = exports.createAction = exports.indexAction = undefined;
	...
	var indexAction = exports.indexAction = function indexAction(store) {
		var page = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];


		_http2.default.get('post', { params: { page: page } }).then(function (result) {
	...
	var createAction = exports.createAction = function createAction(store) {
		_http2.default.get('post/create').then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var storeAction = exports.storeAction = function storeAction(store, data) {
		_http2.default.post('post/create', data).then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var editAction = exports.editAction = function editAction(store) {
		var post_id = store.state.route.params.post_id;
		if (!post_id) {
			store.dispatch('ALERT', { type: 'danger', msg: '数据不存在' });
		}
		_http2.default.get('post/' + post_id + '/edit').then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var updateAction = exports.updateAction = function updateAction(store, data) {
		var post_id = store.state.route.params.post_id;
		if (!post_id) {
			store.dispatch('ALERT', { type: 'danger', msg: '数据不存在' });
		}
		_http2.default.put('post/' + post_id + '/edit', data).then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var deleteAction = exports.deleteAction = function deleteAction(store, id) {
		return new Promise(function (resolve, reject) {
			_http2.default.delete('post/' + id).then(function (result) {
				var data = result.data;
				if (data.success == true) {
	...
	var uploadCoverAction = exports.uploadCoverAction = function uploadCoverAction(store, files) {
		if (files.length > 0) {
			(0, _common.uploadAction)(files[0]).then(function (result) {
				store.dispatch(_mutationTypes.POST_UPLOAD_COVER, result.url);
			});
		} else {
	...
	var deleteCoverAction = exports.deleteCoverAction = function deleteCoverAction(store, file) {
		store.dispatch(_mutationTypes.POST_DELETE_COVER);
	};

	var editorAction = exports.editorAction = function editorAction(store, text) {
		store.dispatch(_mutationTypes.POST_EDITOR, text);
	};

	var uploadAttachmentAction = exports.uploadAttachmentAction = function uploadAttachmentAction(store, files) {
		if (files.length > 0) {
			(0, _common.uploadAction)(files[0]).then(function (result) {
				store.dispatch(_mutationTypes.POST_UPLOAD_ATTACHMENT, result.url);
			});
		} else {
			store.dispatch('ALERT', { type: 'danger', msg: '没有选择文件' });
		}
	...
	var deleteAttachmentAction = exports.deleteAttachmentAction = function deleteAttachmentAction(store, file) {
		store.dispatch(_mutationTypes.POST_DELETE_ATTACHMENT);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] backend\\views\\post\\create.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simplemde = __webpack_require__(119);
	...
	exports.default = {
		...
		vuex: {
			actions: {
				createAction: _post.createAction,
				storeAction: _post.storeAction,
				uploadCoverAction: _post.uploadCoverAction,
				deleteCoverAction: _post.deleteCoverAction,
				editorAction: _post.editorAction,
				uploadAttachmentAction: _post.uploadAttachmentAction,
				deleteAttachmentAction: _post.deleteAttachmentAction
			},
			getters: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] backend\\components\\simplemde.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.8.5.2@vue-loader/lib/style-rewriter.js!./../../node_modules/.8.5.2@vue-loader/lib/selector.js?type=style&index=0!./simplemde.vue", function() {
				var newContent = require("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.8.5.2@vue-loader/lib/style-rewriter.js!./../../node_modules/.8.5.2@vue-loader/lib/selector.js?type=style&index=0!./simplemde.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simplemdeMin = __webpack_require__(126);
		...
		props: {
			...
			toolbar: {
				...
				default: function _default() {
					return [{
						name: "bold",
						action: _simplemdeMin2.default.toggleBold,
						className: "fa fa-bold",
						title: "Bold"
					}, {
						name: "italic",
						action: _simplemdeMin2.default.toggleItalic,
						className: "fa fa-italic",
						title: "Italic"
					}, {
						name: "heading",
						action: _simplemdeMin2.default.toggleHeadingSmaller,
						className: "fa fa-header",
						title: "Heading"
					}, '|', {
						name: "code",
						action: _simplemdeMin2.default.toggleCodeBlock,
						className: "fa fa-code",
						title: "Code"
					}, {
						name: "quote",
						action: _simplemdeMin2.default.toggleBlockquote,
						className: "fa fa-quote-left",
						title: "Quote"
					}, '|', {
						name: "unordered-list",
						action: _simplemdeMin2.default.toggleUnorderedList,
						className: "fa fa-list-ul",
						title: "Generic List"
					}, {
						name: "ordered-list",
						action: _simplemdeMin2.default.toggleOrderedList,
						className: "fa fa-list-ol",
						title: "Numbered List"
					}, '|', {
						name: "link",
						action: _simplemdeMin2.default.drawLink,
						className: "fa fa-link",
						title: "Create Link"
					}, {
						name: "image",
						action: _simplemdeMin2.default.drawImage,
						className: "fa fa-picture-o",
						title: "Insert Image"
					}, {
						name: "table",
						action: _simplemdeMin2.default.drawTable,
						className: "fa fa-table",
						title: "Insert Table"
					}, {
						name: "horizontal-rule",
						action: _simplemdeMin2.default.drawHorizontalRule,
						className: "fa fa-minus",
						title: "Insert Horizontal Line"
					}, '|', {
						name: "clean-block",
						action: _simplemdeMin2.default.cleanBlock,
						className: "fa fa-eraser fa-clean-block",
						title: "Clean block"
					}, {
						name: "undo",
						action: _simplemdeMin2.default.undo,
						className: "fa fa-undo no-disable",
						title: "Undo"
					}, {
						name: "redo",
						action: _simplemdeMin2.default.redo,
						className: "fa fa-repeat no-disable",
						title: "Redo"
					}, '|', {
						name: "preview",
						action: _simplemdeMin2.default.togglePreview,
						className: "fa fa-eye no-disable",
						title: "Toggle Preview"
					}, {
						name: "side-by-side",
						action: _simplemdeMin2.default.toggleSideBySide,
						className: "fa fa-columns no-disable no-mobile",
						title: "Toggle Side by Side"
					}, {
						name: "fullscreen",
						action: _simplemdeMin2.default.toggleFullScreen,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/.0.25.0@css-loader/index.js!./simplemde.min.css", function() {
				var newContent = require("!!./../../../../../node_modules/.0.25.0@css-loader/index.js!./simplemde.min.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] backend\\components\\upload.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.8.5.2@vue-loader/lib/style-rewriter.js!./../../node_modules/.8.5.2@vue-loader/lib/selector.js?type=style&index=0!./upload.vue", function() {
				var newContent = require("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.8.5.2@vue-loader/lib/style-rewriter.js!./../../node_modules/.8.5.2@vue-loader/lib/selector.js?type=style&index=0!./upload.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
		...
		props: {
			...
			action: {
				...
				default: function _default(files) {
					console.log('empty upload action');
				}
			},
			changeUpload: {
				type: Boolean,
