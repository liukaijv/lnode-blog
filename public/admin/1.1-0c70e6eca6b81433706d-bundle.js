...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] backend\\views\\layout.vue: named exports in *.vue files are ignored.")}
	...
	exports.default = {
		...
		vuex: {
			actions: {
				...
				authorizedAction: _auth.authorizedAction,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.updateAction = exports.authorizedAction = exports.logoutAction = exports.loginAction = undefined;
	...
	var loginAction = exports.loginAction = function loginAction(store, data) {
		_http2.default.post('login', data).then(function (result) {
			var data = result.data;
			if (data.success == true) {
				sessionStorage.setItem('jwt_token', data.user.access_token);
				sessionStorage.setItem('auth_user', JSON.stringify(data.user));
				store.dispatch(_mutationTypes.LOGIN, data.user);
	...
	var logoutAction = exports.logoutAction = function logoutAction(store) {
		_http2.default.post('logout').then(function (result) {
			var data = result.data;
			if (data.success == true) {
				sessionStorage.removeItem('jwt_token');
				sessionStorage.removeItem('auth_user');
				store.dispatch(_mutationTypes.LOGOUT, data.categories);
				store.router.go('/login');
			}
		});
	};

	var authorizedAction = exports.authorizedAction = function authorizedAction(store) {
		var auth_user = null;
		...
		store.dispatch(_mutationTypes.AUTHORIZED, auth_user);
	...
	var updateAction = exports.updateAction = function updateAction(store, data) {
		_http2.default.post('profile', data).then(function (result) {
			var data = result.data;
			if (data.success == true) {
				sessionStorage.setItem('auth_user', JSON.stringify(data.user));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] backend\\views\\partial\\sidebar.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collapseMenu = __webpack_require__(82);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<aside class=\"main-sidebar\">\n    <section class=\"sidebar\">\n        <ul class=\"sidebar-menu\" v-menu>\n            <li>\n                <a v-link=\"{name:'dashboard'}\">\n                    <i class=\"fa fa-dashboard\"></i>                   \n                    <span>首页</span>\n                </a>\n            </li>\n            <li class=\"treeview\">\n                <a href=\"#\">\n                    <i class=\"fa fa-sitemap\"></i>\n                    <span>分类</span>\n                    <i class=\"fa fa-angle-left pull-right\"></i>\n                </a>\n                <ul class=\"treeview-menu\">\n                    <li>\n                        <a v-link=\"{name:'category_index'}\">\n                            <i class=\"fa fa-circle-o\"></i>\n                          分类列表\n                        </a>\n                    </li>\n                    <li>\n                        <a v-link=\"{name:'category_create'}\">\n                            <i class=\"fa fa-circle-o\"></i>\n                           分类新增\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</li>\n                </ul>\n            </li>\n            <li class=\"treeview\">\n                <a href=\"#\">\n                    <i class=\"fa fa-tags\"></i>\n                    <span>标签</span>\n                    <i class=\"fa fa-angle-left pull-right\"></i>\n                </a>\n                <ul class=\"treeview-menu\">\n                    <li>\n                        <a v-link=\"{name:'tag_index'}\">\n                            <i class=\"fa fa-circle-o\"></i>\n                          标签列表\n                        </a>\n                    </li>\n                    <li>\n                        <a v-link=\"{name:'tag_create'}\">\n                            <i class=\"fa fa-circle-o\"></i>\n                           标签新增\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</li>\n                </ul>\n            </li> \n            <li class=\"treeview\">\n                <a href=\"#\">\n                    <i class=\"fa fa-file\"></i>\n                    <span>文章</span>\n                    <i class=\"fa fa-angle-left pull-right\"></i>\n                </a>\n                <ul class=\"treeview-menu\">\n                    <li>\n                        <a v-link=\"{name:'post_index'}\">\n                            <i class=\"fa fa-circle-o\"></i>\n                          文章列表\n                        </a>\n                    </li>\n                    <li>\n                        <a v-link=\"{name:'post_create'}\">\n                            <i class=\"fa fa-circle-o\"></i>\n                           文章新增\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</li>\n                </ul>\n            </li>\t                            \n        </ul>\n    </section>\n</aside>\t\n";
