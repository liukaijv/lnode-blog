webpackJsonp([2],Array(56).concat([
/* 56 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] backend\\views\\dashboard.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		vuex: {
			actions: {
				dashboardAction: _dashboard.dashboardAction
			},
			getters: {
				post_count: function post_count(_ref) {
					var dashboard = _ref.dashboard;
					return dashboard.post_count;
				},
				tag_count: function tag_count(_ref2) {
					var dashboard = _ref2.dashboard;
					return dashboard.tag_count;
				},
				category_count: function category_count(_ref3) {
					var dashboard = _ref3.dashboard;
					return dashboard.category_count;
				}
			}
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dashboardAction(store) {
		_http2.default.get('dashboard').then(function (result) {
