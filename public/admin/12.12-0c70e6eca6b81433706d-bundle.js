...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] backend\\views\\user\\edit.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _user2 = __webpack_require__(139);
	...
	exports.default = {
		...
		vuex: {
			actions: {
				editAction: _user2.editAction,
				updateAction: _user2.updateAction
			},
			getters: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexAction = exports.indexAction = function indexAction(store) {
		...
		_http2.default.get('user', { params: { page: page } }).then(function (result) {
	...
	var storeAction = exports.storeAction = function storeAction(store, data) {
		_http2.default.post('user/create', data).then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var editAction = exports.editAction = function editAction(store) {
		var user_id = store.state.route.params.user_id;
		if (!user_id) {
			store.dispatch('ALERT', { type: 'danger', msg: '数据不存在' });
		}
		_http2.default.get('user/' + user_id + '/edit').then(function (result) {
			var data = result.data;
			if (data.success == true) {
	...
	var updateAction = exports.updateAction = function updateAction(store, data) {
		...
		_http2.default.put('user/' + user_id + '/edit', data).then(function (result) {
			var data = result.data;
			if (data.success == true) {
				if (data.logout) {
	...
	var deleteAction = exports.deleteAction = function deleteAction(store, id) {
		return new Promise(function (resolve, reject) {
			_http2.default.delete('user/' + id).then(function (result) {
				var data = result.data;
				if (data.success == true) {
